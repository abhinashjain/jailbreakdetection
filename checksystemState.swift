...
//            NSLog("\n\n-----------------JailBroken due to Spawned Process-----------------\n\n")
        ...
        {
            NSLog("\n\n-----------------JailBroken due to 2-----------------\n\n")
//            NSLog("\n\n-----------------JailBroken due to Loaded Libraries-----------------\n\n")
            return 1
        }

        ret=Int32(createFileOutsideSandbox())
        if(ret==1)
        {
            NSLog("\n\n-----------------JailBroken due to 3-----------------\n\n")
//            NSLog("\n\n-----------------JailBroken due to File Creation Outside Sandbox-----------------\n\n")
            return 1
        }
        ...
        for i in filename1
        {
            ...
            ret=checkFileExistence(UnsafeMutablePointer<Int8>(mutating: name!));
            if(ret==1)
            {
                NSLog("\n\n" + i + "\n-----------------JailBroken due to 4-----------------\n\n")
//                NSLog("\n\n" + i + "\n-----------------JailBroken due to File Existence-----------------\n\n")
                return 1
            }
        }
        ...
        {
            let name: [CChar]? = i.cString(using: String.Encoding.utf8)
            ret=checkFileAccess(UnsafeMutablePointer<Int8>(mutating: name!));
            if(ret==1)
            {
                NSLog("\n\n" + i + "\n-----------------JailBroken due to 5-----------------\n\n")
//                NSLog("\n\n" + i + "\n-----------------JailBroken due to File Access-----------------\n\n")
                return 1
            }
        }
        ...
        {
            let name: [CChar]? = i.cString(using: String.Encoding.utf8)
            ret=checkFileStat(UnsafeMutablePointer<Int8>(mutating: name!));
            if(ret==1)
            {
                NSLog("\n\n" + i + "\n-----------------JailBroken due to 6-----------------\n\n")
//                NSLog("\n\n" + i + "\n-----------------JailBroken due to File Stat-----------------\n\n")
                return 1
            }
        }
        ...
        {
            NSLog("\n\n-----------------JailBroken due to 7-----------------\n\n")
//            NSLog("\n\n-----------------JailBroken due to the error opening serial port /dev/tty.iap - Resource busy(16).-----------------\n\n")
            return 1
        }
    ...
    func createFileOutsideSandbox() -> Int
    {
        let text="Pink Floyd"
